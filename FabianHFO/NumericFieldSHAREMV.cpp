// NumericFieldSHAREMV.cpp : implementation file
//
...
CNumericField(size)
{
	m_szName=getModel()->GetLanguageString(IDS_PARA_PROZANTEIL);
	...
	{
		m_szNameNote=getModel()->GetLanguageString(IDS_PARA_RESP);
	}
	m_szUnit=_T("");
}
...
BEGIN_MESSAGE_MAP(CNumericFieldSHAREMV, CWnd)

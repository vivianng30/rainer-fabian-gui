// NumericFieldETCO2.cpp : implementation file
//
...
CNumericField(size)
{
	m_szName=getModel()->GetLanguageString(IDS_PARA_ETCO);
	m_szNameNote=_T("2");
...
BEGIN_MESSAGE_MAP(CNumericFieldETCO2, CWnd)
...
bool CNumericFieldETCO2::drawData(bool, bool bFrames, bool bText, bool bLimits, bool)
{
	...
	if(bETCO2ValueValid)
	{
		wsprintf(psz,_T("%0.0f"), ((double)iETCO2)/10);
	}
	else
	{

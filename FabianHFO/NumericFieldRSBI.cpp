// NumericFieldRSBI.cpp : implementation file
//
...
CNumericField(size)
{
	m_szName=getModel()->GetLanguageString(IDS_PARA_RSBI);
	m_szNameNote=_T("");
...
BEGIN_MESSAGE_MAP(CNumericFieldRSBI, CWnd)
...
bool CNumericFieldRSBI::drawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
	...
	if(iTVEpat!=0)
		iRSBI=(double)iBPM/((double)iTVEpat/10);

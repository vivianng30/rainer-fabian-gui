...
//* \brief	Declares the alarm condition handler class.
//*
//*
...
public:
	...
	/*void setAlimit(eAlarmLimits enAlarmLimit,
...
private: 
	CAlarmLimitList* m_pAlarmLimitlist;
	CRITICAL_SECTION csAlarmLimitList;

	CMVModel *m_pModel;

	static CAlarmLimitPtr ALIMIT_MVMAX;
	static CAlarmLimitPtr ALIMIT_MVMIN;
	static CAlarmLimitPtr ALIMIT_PIPMAX;
	static CAlarmLimitPtr ALIMIT_PIPMIN;
	static CAlarmLimitPtr ALIMIT_PEEPMIN; 
	static CAlarmLimitPtr ALIMIT_FREQMAX;
	static CAlarmLimitPtr ALIMIT_LEAKMAX;
	static CAlarmLimitPtr ALIMIT_APNOE;
	static CAlarmLimitPtr ALIMIT_DCO2MAX;
	static CAlarmLimitPtr ALIMIT_DCO2MIN;
	static CAlarmLimitPtr ALIMIT_ETCO2MAX;
	static CAlarmLimitPtr ALIMIT_ETCO2MIN;
	static CAlarmLimitPtr ALIMIT_FICO2MAX;
	static CAlarmLimitPtr ALIMIT_FICO2MIN;
	static CAlarmLimitPtr ALIMIT_SPO2MAX;
	static CAlarmLimitPtr ALIMIT_SPO2MIN;
	static CAlarmLimitPtr ALIMIT_PULSERATEMAX;
	static CAlarmLimitPtr ALIMIT_PULSERATEMIN;
	static CAlarmLimitPtr ALIMIT_SPO2PIMIN;
	static CAlarmLimitPtr ALIMIT_SPO2SIQMIN;

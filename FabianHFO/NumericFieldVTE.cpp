// NumericFieldVTE.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CNumericFieldVTE, CWnd)
...
bool CNumericFieldVTE::drawData(bool, bool bFrames, bool bText, bool, bool)
{
...
bool CNumericFieldVTE::drawLimits(CDC*)
{

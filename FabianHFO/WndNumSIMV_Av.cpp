// WndNumSIMV_Av.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumSIMV_Av, CWnd)

CWndNumSIMV_Av::CWndNumSIMV_Av():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumSIMV_Av, CWnd)
	//{{AFX_MSG_MAP(CWndNumSIMV_Av)
	ON_WM_DESTROY()
...
//************************************
// Method:    OnDestroy
// FullName:  CWndNumSIMV_Av::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
// 
// **************************************************************************
bool CWndNumSIMV_Av::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumSIMV_Av::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIMV_Av::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIMV_Av::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;
	int nBkMode=SetBkMode(hdc,TRANSPARENT);
	HFONT hPrevFont=(HFONT)SelectObject(hdc,g_hf11AcuBold);

// WndNumSIPPV_Mech.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumSIPPV_Mech, CWnd)

CWndNumSIPPV_Mech::CWndNumSIPPV_Mech():
CWndNumeric()
{
	...
	m_szName8=getModel()->GetLanguageString(IDS_PARA_V);
	m_szName9=getModel()->GetLanguageString(IDS_PARA_FREQ);
	m_szName10=getModel()->GetLanguageString(IDS_PARA_LEAK);
...
BEGIN_MESSAGE_MAP(CWndNumSIPPV_Mech, CWnd)
	//{{AFX_MSG_MAP(CWndNumSIPPV_Mech)
	ON_WM_DESTROY()
	ON_WM_TIMER()
...
// CWndNumSIPPV_Mech message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumSIPPV_Mech::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
//************************************
void CWndNumSIPPV_Mech::OnDestroy() 
{
...
// 
// **************************************************************************
bool CWndNumSIPPV_Mech::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumSIPPV_Mech::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIPPV_Mech::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
	...
	CSize sz1,sz2,sz3,sz4,sz5,sz6,sz8;
...
// 
// **************************************************************************
bool CWndNumSIPPV_Mech::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;
	...
	if(false==m_bGraphCursor)
	{
		...
		//m_pcLimitLow_Up->Draw(hdc,120,386);//right-60, bottom-16

// NumericFieldSPO2.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CNumericFieldSPO2, CWnd)
...
bool CNumericFieldSPO2::drawData(bool, bool bFrames, bool bText, bool bLimits, bool)
{
	...
	if(iSPO2>0)
	{
		wsprintf(psz,_T("%0.0f"), CTlsFloat::Round(((double)iSPO2)/10, 0));
	}
	else
	{

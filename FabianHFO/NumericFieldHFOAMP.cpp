// NumericFieldHFOAMP.cpp : implementation file
//
...
CNumericField(size)
{
	m_szName=getModel()->GetLanguageString(IDS_PARA_HFO);
	m_szNameNote=getModel()->GetLanguageString(IDS_PARA_AMPL);
...
BEGIN_MESSAGE_MAP(CNumericFieldHFOAMP, CWnd)

// WndNumSIPPV_Av.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumSIPPV_Av, CWnd)

CWndNumSIPPV_Av::CWndNumSIPPV_Av():
CWndNumeric()
{
	...
	m_szName6=getModel()->GetLanguageString(IDS_PARA_FREQ);
	m_szName7=getModel()->GetLanguageString(IDS_PARA_LEAK);
...
BEGIN_MESSAGE_MAP(CWndNumSIPPV_Av, CWnd)
	//{{AFX_MSG_MAP(CWndNumSIPPV_Av)
	ON_WM_DESTROY()
...
// CWndNumSIPPV_Av message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumSIPPV_Av::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
//************************************
void CWndNumSIPPV_Av::OnDestroy() 
{
...
// 
// **************************************************************************
bool CWndNumSIPPV_Av::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumSIPPV_Av::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIPPV_Av::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIPPV_Av::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;
	int nBkMode=SetBkMode(hdc,TRANSPARENT);
	HFONT hPrevFont=(HFONT)SelectObject(hdc,g_hf11AcuBold);

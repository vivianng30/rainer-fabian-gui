/**********************************************************************************************//**
 * \file	WndPassword.cpp.
 *
 * Implements the window password class
 **************************************************************************************************/
...
/**********************************************************************************************//**
 * Initializes a new instance of the WndPassword class
 *
 * \author	Rainer Kühner
 * \date	26.02.2018
 *
...
IMPLEMENT_DYNAMIC(CWndPassword, CWnd)

/**********************************************************************************************//**
 * Initializes a new instance of the CWndPassword class
 *
 * \author	Rainer Kühner
 * \date	26.02.2018
 **************************************************************************************************/
...
/**********************************************************************************************//**
 * Finalizes an instance of the CWndPassword class
 *
 * \author	Rainer Kühner
 * \date	26.02.2018
 **************************************************************************************************/
...
CMVModel *CWndPassword::getModel()
{
	if(m_pModel==NULL)
...
BEGIN_MESSAGE_MAP(CWndPassword, CWnd)
	//ON_WM_PAINT()
	ON_WM_DESTROY()
	//ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_DEL, &CWndPassword::OnBnClickedDel)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_1, &CWndPassword::OnBnClicked_1)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_2, &CWndPassword::OnBnClicked_2)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_3, &CWndPassword::OnBnClicked_3)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_4, &CWndPassword::OnBnClicked_4)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_5, &CWndPassword::OnBnClicked_5)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_6, &CWndPassword::OnBnClicked_6)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_7, &CWndPassword::OnBnClicked_7)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_8, &CWndPassword::OnBnClicked_8)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_9, &CWndPassword::OnBnClicked_9)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_0, &CWndPassword::OnBnClicked_0)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_a, &CWndPassword::OnBnClicked_a)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_b, &CWndPassword::OnBnClicked_b)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_c, &CWndPassword::OnBnClicked_c)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_d, &CWndPassword::OnBnClicked_d)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_e, &CWndPassword::OnBnClicked_e)
	ON_BN_CLICKED(IDC_BTN_SETUP_KBRD_f, &CWndPassword::OnBnClicked_f)
END_MESSAGE_MAP()

/**********************************************************************************************//**
 * CWndPassword-Meldungshandler
 *
 * \author	Rainer Kühner
 * \date	26.02.2018
 *
...
void CWndPassword::Show(bool bShow)
{
	if(bShow)
	{
...
void CWndPassword::OnBnClickedDel()
{
	Key(-1);
}
...
void CWndPassword::OnBnClicked_1()
{
	Key('1');
}
...
void CWndPassword::OnBnClicked_2()
{
	Key('2');
}
...
void CWndPassword::OnBnClicked_3()
{
	Key('3');
}
...
void CWndPassword::OnBnClicked_4()
{
	Key('4');
}
...
void CWndPassword::OnBnClicked_5()
{
	Key('5');
}
...
void CWndPassword::OnBnClicked_6()
{
	Key('6');
}
...
void CWndPassword::OnBnClicked_7()
{
	Key('7');
}
...
void CWndPassword::OnBnClicked_8()
{
	Key('8');
}
...
void CWndPassword::OnBnClicked_9()
{
	Key('9');
}
...
void CWndPassword::OnBnClicked_0()
{
	Key('0');
}
...
void CWndPassword::OnBnClicked_e()
{
	Key('E');
}
...
void CWndPassword::OnBnClicked_a()
{
	Key('A');
}
...
void CWndPassword::OnBnClicked_d()
{
	Key('D');
}
...
void CWndPassword::OnBnClicked_f()
{
	Key('F');
}
...
void CWndPassword::OnBnClicked_c()
{
	Key('C');
}
...
void CWndPassword::OnBnClicked_b()
{
	Key('B');
}
...
void CWndPassword::BnClickedCancel()
{
	if(GetParent())
...
LRESULT CWndPassword::WindowProc(UINT message, WPARAM wParam, LPARAM lParam )
{
	switch(message)
	{

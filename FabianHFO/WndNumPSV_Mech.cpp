// WndNumPSV_Mech.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CWndNumPSV_Mech, CWnd)

CWndNumPSV_Mech::CWndNumPSV_Mech():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumPSV_Mech, CWnd)
	//{{AFX_MSG_MAP(CWndNumPSV_Mech)
	ON_WM_DESTROY()
	ON_WM_TIMER()
...
// CWndNumPSV_Mech message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumPSV_Mech::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
//************************************
void CWndNumPSV_Mech::OnDestroy() 
{
...
// 
// **************************************************************************
bool CWndNumPSV_Mech::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumPSV_Mech::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumPSV_Mech::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumPSV_Mech::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;

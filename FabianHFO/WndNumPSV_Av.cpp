// WndNumPSV_Av.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CWndNumPSV_Av, CWnd)

CWndNumPSV_Av::CWndNumPSV_Av():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumPSV_Av, CWnd)
...
// CWndNumPSV_Av message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumPSV_Av::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
// 
// **************************************************************************
bool CWndNumPSV_Av::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumPSV_Av::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumPSV_Av::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumPSV_Av::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;
	int nBkMode=SetBkMode(hdc,TRANSPARENT);
	HFONT hPrevFont=(HFONT)SelectObject(hdc,g_hf11AcuBold);

...
void CConfiguration::LoadSettings()
{
	...
	WORD iMAXRANGE_PED_TRIGGER_NMODE=(WORD)regLimit.ReadDWORD(_T("MAXRANGE_PED_TRIGGER_NMODE"), MAXRANGE_PED_TRIGGER_NMODE);
	WORD iMINRANGE_PED_TRIGGER_NMODE=(WORD)regLimit.ReadDWORD(_T("MINRANGE_PED_TRIGGER_NMODE"), MINRANGE_PED_TRIGGER_NMODE);
	//m_iParaDataTrigger;

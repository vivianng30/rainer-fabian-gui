// WndNumAvCPAP.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumCPAP_Av, CWnd)

CWndNumCPAP_Av::CWndNumCPAP_Av():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumCPAP_Av, CWnd)
	//{{AFX_MSG_MAP(CWndNumCPAP_Av)
	ON_WM_DESTROY()
...
// CWndNumCPAP_Av message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumCPAP_Av::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
// 
// **************************************************************************
bool CWndNumCPAP_Av::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumCPAP_Av::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumCPAP_Av::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumCPAP_Av::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;

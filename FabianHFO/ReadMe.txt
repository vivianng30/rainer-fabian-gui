================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FabianHFO Project Overview
===============================================================================
änderung branch
The application wizard has created this FabianHFO application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FabianHFO application.
...
FabianHFO.h
    ...
    project specific headers and declares the CFabianHFOApp application class.
...
StdAfx.h, StdAfx.cpp
    ...
    named FabianHFO.pch and a precompiled types file named StdAfx.obj.

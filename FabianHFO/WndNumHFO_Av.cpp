// WndNumHFO.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumHFO_Av, CWnd)

CWndNumHFO_Av::CWndNumHFO_Av():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumHFO_Av, CWnd)
	//{{AFX_MSG_MAP(CWndNumHFO_Av)
	ON_WM_DESTROY()
...
// CWndNumHFO_Av message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumHFO_Av::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
// 
// **************************************************************************
bool CWndNumHFO_Av::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumHFO_Av::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumHFO_Av::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
	...
	CSize sz1,sz2,sz3,sz4,sz5,sz6,sz7,sz8;
	...
	CSize sz2Note,sz3Note,sz4Note,sz5Note,sz6Note,sz7Note,sz8Note;
...
// 
// **************************************************************************
bool CWndNumHFO_Av::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;

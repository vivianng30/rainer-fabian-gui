 ...
 * @date 2017-08-25
 * @verbatim
	- alarm handling: ALARM_SysAl_P_IN_O2, ALARM_SysAl_P_IN_AIR, ALARM_SysFail_OUTOFMEMORY, ALARM_SysFail_VOLTAGE alarms will be checked for isActiveAlarmHigherPriority
 @endverbatim
 *
 ...
 * @verbatim
	...
	- FOT: last value of CPAP backup will be saved and restored after FOT
 @endverbatim
 *

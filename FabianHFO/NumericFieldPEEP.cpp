// NumericFieldPEEP.cpp : implementation file
//
...
CNumericField(size)
{
	m_szName=getModel()->GetLanguageString(IDS_PARA_PEEP);
	m_szNameNote=_T("");
...
BEGIN_MESSAGE_MAP(CNumericFieldPEEP, CWnd)
...
bool CNumericFieldPEEP::drawData(bool, bool bFrames, bool bText, bool bLimits, bool)
{

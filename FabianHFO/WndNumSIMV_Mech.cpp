// WndNumSIMV_Mech.cpp: Implementierungsdatei
//
...
IMPLEMENT_DYNAMIC(CWndNumSIMV_Mech, CWnd)

CWndNumSIMV_Mech::CWndNumSIMV_Mech():
CWndNumeric()
{
...
BEGIN_MESSAGE_MAP(CWndNumSIMV_Mech, CWnd)
	//{{AFX_MSG_MAP(CWndNumSIMV_Mech)
	ON_WM_DESTROY()
	ON_WM_TIMER()
...
// CWndNumSIMV_Av message handlers
//************************************
// Method:    OnDestroy
// FullName:  CWndNumSIMV_Mech::OnDestroy
// Access:    protected 
// Returns:   void
// Qualifier:
//
...
//************************************
void CWndNumSIMV_Mech::OnDestroy() 
{
...
// 
// **************************************************************************
bool CWndNumSIMV_Mech::DrawData(bool bData, bool bFrames, bool bText, bool bLimits, bool bFlowmeter)
{
...
// 
// **************************************************************************
bool CWndNumSIMV_Mech::DrawFrames(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIMV_Mech::DrawStaticText(CDC* pDC)
{
	HDC hdc = *pDC;
...
// 
// **************************************************************************
bool CWndNumSIMV_Mech::DrawLimits(CDC* pDC)
{
	HDC hdc = *pDC;
	int nBkMode=SetBkMode(hdc,TRANSPARENT);
	HFONT hPrevFont=(HFONT)SelectObject(hdc,g_hf11AcuBold);

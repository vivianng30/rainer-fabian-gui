// NumericFieldC20C.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CNumericFieldC20C, CWnd)
...
bool CNumericFieldC20C::drawStaticText(CDC* pDC)
{
	...
	if(m_eSize==NUMERICSIZE_1)
	{
		...
		rc.top = 9;
		rc.left = 17+sz1.cx+szNote.cx;
		pDC->DrawText(_T(" / ")+m_szName,&rc,DT_TOP|DT_SINGLELINE|DT_LEFT);
	}
	else //if(m_eSize==NUMERICSIZE_2)
	{

...
bool CInterfaceI2C::SetFRAMDefaultFactoryValues()
{
	...
	WriteConfigWord(PARA_TRIGGER_CONV_16,FACTORY_SIPPV_TRIGGER);
	WriteConfigWord(PARA_TRIGGER_NMODE_16,FACTORY_NMODE_TRIGGER);
...
bool CInterfaceI2C::SetFRAMDefaultFactoryConfig()
{
	...
	WriteConfigByte(TRIGGERTYPENMODE_8,TRIGGER_FLOW);

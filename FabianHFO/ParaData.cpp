...
void CParaData::loadLimits()
{
	...
	m_dataMaxRange_NEONATAL.m_iParaDataTriggerNMODE=(BYTE)regLimit.ReadDWORD(_T("MAXRANGE_NEO_TRIGGER_DUOPAP"), MAXRANGE_NEO_TRIGGER_NMODE);
	...
	m_dataMinRange_NEONATAL.m_iParaDataTriggerNMODE=(BYTE)regLimit.ReadDWORD(_T("MINRANGE_NEO_TRIGGER_NMODE"), MINRANGE_NEO_TRIGGER_NMODE);
	...
	m_dataMaxRange_PEDIATRIC.m_iParaDataTriggerNMODE=(BYTE)regLimit.ReadDWORD(_T("MAXRANGE_PED_TRIGGER_NMODE"), MAXRANGE_PED_TRIGGER_NMODE);
	...
	m_dataMinRange_PEDIATRIC.m_iParaDataTriggerNMODE=(BYTE)regLimit.ReadDWORD(_T("MINRANGE_PED_TRIGGER_NMODE"), MINRANGE_PED_TRIGGER_NMODE);
